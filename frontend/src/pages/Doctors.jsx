...
const [showFilter, setShowFilter] = useState(false)
  ...
  return (
    <div>
      <p className=' text-gray-600 '>Explore a wide range of medical specialists.</p>
      
      {/* Flex container holds BOTH sidebar and doctor cards */}
      <div className='flex flex-col sm:flex-row items-start gap-5 mt-5'>
        ...
        <div className={` flex-col gap-4 text-sm text-gray-600 ${showFilter ?'flex':'hidden sm:flex'}`}>
          ...
          <p onClick={()=>speciality===''?navigate('/doctors'):navigate(`/doctors/Cardiologist`)} className={`w-[94vw] sm:w-auto pl-3 py-1.5 pr-16 border border-gray-300 rounded transition-all cursor-pointer  ${speciality === "Cardiologist" ? "bg-indigo-100 text-black":""}`}>Cardiologist</p>
        </div>
